...
public class WebSecurityConfig {
    ...
    /**
     * Konfigurasi CORS global untuk seluruh endpoint, termasuk controller yang
     * akan ditambahkan di masa depan. Frontend dapat mengirim JSON dan header
     * Authorization (Bearer token) dari origin mana pun.
     */
    @Bean
